...
import { SHOOT_TYPES, requiredSlots, slotLabel, type ShootType, type SlotKey } from "@/lib/studio";
...
type Phase = "opening" | "mode-select" | "flipping" | "panty" | "advancing";
...
export function BookView({ onClose }: BookViewProps) {
  ...
  }, [phase, primaryReady, needsFlip, pantyReady, playFlip]);
        ...
        {phase === "advancing" ? (
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="rounded-full bg-black/60 px-6 py-3 text-sm font-medium tracking-wide text-white">
              Continuing to deck &amp; brand setup — coming in Stage 2
            </p>
          </div>
        ) : null}
      </div>
